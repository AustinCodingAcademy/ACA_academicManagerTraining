...
- Tutors see the students in one-on-one scenarios and often find themselves in conversation with the students that highlight their struggles. Communicate with tutors about students' learning trends including assignments or concepts that students commonly find difficult.
    ...
    * Engage the tutors in conversation outside of class where they might more easily show you how students are progressing.
...
- Maintaining accurate and judicious notes on each student is crucial to all parts to the student experience from application and admission to graduation and job placement. Your entire team will use [HubSpot](https://app.hubspot.com/login) to track each students journey throughout their time with us because knowing the student is key to placing them in their first developer role.
    
    * Marketing will create the contact of the student and generate notes on their Campus of interest and potential for class.
    *  Each time Admissions interacts with a student they will make notes on who they are, why they're interested, when they'd like to join, and what makes them a great fit.
...
- Email is a great way to reach out to students, so long as you've properly introduce them to email etiquette and email expectations, i.e. reading and responding within one day, using reply all or not, adding a signature. Common emails you might send:
    ...
    * Invitations and Meetup suggestions
